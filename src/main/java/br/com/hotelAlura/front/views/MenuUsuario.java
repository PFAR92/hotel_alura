...
public class MenuUsuario extends JFrame {
    ...
    public MenuUsuario() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(MenuUsuario.class.getResource("/br/com/hotelAlura/front/imagens/aH-40px.png")));
        ...
        lblBusquedaDeReservas.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/br/com/hotelAlura/front/imagens/pessoas.png"))));
        ...
        panelMenu.add(logo);
        logo.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/br/com/hotelAlura/front/imagens/aH-150px.png"))));
        ...
        labelRegistro.setIcon(new ImageIcon(Objects.requireNonNull(MenuUsuario.class.getResource("/br/com/hotelAlura/front/imagens/reservado.png"))));
