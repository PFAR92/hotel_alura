...
public class Login extends JFrame {
    ...
    public Login() {
        ...
        imgHotel.setIcon(new ImageIcon(Objects.requireNonNull(Login.class.getResource("/br/com/hotelAlura/front/imagens/img-hotel-login-.png"))));
        ...
        logo.setIcon(new ImageIcon(Objects.requireNonNull(Login.class.getResource("/br/com/hotelAlura/front/imagens/lOGO-50PX.png"))));
