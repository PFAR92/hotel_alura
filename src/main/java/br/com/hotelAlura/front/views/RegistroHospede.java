...
public class RegistroHospede extends JFrame {
    ...
    public RegistroHospede(Reserva reserva) {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHospede.class.getResource("/br/com/hotelAlura/front/imagens/lOGO-50PX.png")));
        ...
        txtDataN.getCalendarButton().setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelAlura/front/imagens/icon-reservas.png")));
        ...
        btnsalvar.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                nome = Comandos.verificaInput(txtNome.getText(), "NOME");
                sobrenome = Comandos.verificaInput(txtSobrenome.getText(), "SOBRENOME");
                try {
                    dataNascimento = Comandos.verificaInput(txtDataN.getDate().toInstant().atZone(ZoneId.systemDefault()).toLocalDate());
                } catch (NullPointerException ex) {
                    JOptionPane.showMessageDialog(null, "É obrigatório a data de nascimento",
                            "Atenção", JOptionPane.INFORMATION_MESSAGE);
                }
                nacionalidade = (String) txtNacionalidade.getModel().getSelectedItem();
                telefone = Comandos.verificaInput(txtTelefone.getText());
                Hospede hospede = new Hospede(nome, sobrenome, Date.valueOf(dataNascimento), nacionalidade, telefone, reserva.getId());

                if (salvarHospede(nome, sobrenome, dataNascimento, telefone)) {
        ...
        imageFundo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelAlura/front/imagens/registro.png")));

        JLabel logo = new JLabel("");
        logo.setBounds(194, 39, 104, 107);
        panel.add(logo);
        logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelAlura/front/imagens/Ha-100px.png")));
    }

    private boolean salvarHospede(String nome, String sobrenome, LocalDate data, String telefone) {
        return nome != null && sobrenome != null && data != null && telefone != null;
    }
